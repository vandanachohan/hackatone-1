...
const config: Config = {
  ...
  url: 'https://hackatone-1-agb0wfxvq-vandanachans-projects.vercel.app', // Updated for Vercel
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Spec-Kit Plus',
              href: 'https://github.com/specifyplus/spec-kit-plus',
            },
          ],
        },
      ],
